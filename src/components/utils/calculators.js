...
export let calculateReturns = (inputValue, ownOdd, totalOdds, odd1, odd2) => {
    if (inputValue === 0 && ownOdd === 0 && totalOdds === 0 && odd1 === 0 && odd2 ===0){
        return 0;
    }
    ...
    let result = Math.round((currentBetAmount * ownOdd) - otherBetAmount1 - otherBetAmount2)
    return result;
}
...
let oddsWithAmount = (state, fixture) => {
    ...
    let updatedState = {
        ...
        w1 : { 
                ...
                returns : calculateReturns(state.totalAmount, fixture.w1, totalOdds, fixture.x, fixture.w2),
            },
        x : { 
                odd : fixture.x,
                betAmount : calculateBetAmount(state.totalAmount, fixture.x, totalOdds),
                returns : calculateReturns(state.totalAmount, fixture.x, totalOdds, fixture.w1, fixture.w2),
            },
        w2 : { 
                odd : fixture.w2,
                betAmount : calculateBetAmount(state.totalAmount, fixture.w2, totalOdds),
                returns : calculateReturns(state.totalAmount, fixture.w2, totalOdds, fixture.w1, fixture.x),
            },
        totalOdds           
    }
    return updatedState;
...
let oddsWithInputValue = (state, e) => {
    ...
    let updatedState = {
        ...
        w1 :{ 
                ...
                returns : calculateReturns(inputValue, state.w1.odd, state.totalOdds, state.x.odd, state.w2.odd) 
            },
        x : { 
                ...state.x, 
                betAmount : calculateBetAmount(inputValue, state.x.odd, state.totalOdds),
                returns : calculateReturns(inputValue, state.x.odd, state.totalOdds, state.w1.odd, state.w2.odd) 
            },
        w2 :{ 
                ...state.w2, 
                betAmount : calculateBetAmount(inputValue, state.w2.odd, state.totalOdds),
                returns : calculateReturns(inputValue, state.w2.odd, state.totalOdds, state.w1.odd, state.x.odd) 
            },
