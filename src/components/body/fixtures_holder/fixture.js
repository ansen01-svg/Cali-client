...
const Fixture = ({ fixture }) => {
  ...
  const updateOdds = (fixture) => {
    if (
      fixture.w1 === undefined ||
      fixture.x === undefined ||
      fixture.w2 === undefined
    )
      return;
...
const Timeholder = ({ time }) => {
  return (
    <TimeWrapper>
      ...
      {time.starts && (
        <ParaWrapper fontSize="0.8rem">{time.starts}</ParaWrapper>
      )}
      {time.current && (
        <ParaWrapper fontSize="0.8rem">{time.current}</ParaWrapper>
      )}
    </TimeWrapper>
  );
};
...
const TeamOdd = ({ odd }) => {
  return (
    <TeamOddWrapper>
      <ParaWrapper fontSize="0.8rem">{odd ? odd : "-"}</ParaWrapper>
    </TeamOddWrapper>
  );
};
